...
export default function AdminHome() {
  const tiles = [
    { label: "Add Item",  desc: "Create a new menu/stock item", to: "/fooditems",  Icon: PlusCircle },
    { label: "All Items", desc: "Browse & manage items",        to: "/allitems",   Icon: Package },
    { label: "Edit Items",desc: "Bulk edit, update prices",     to: "/edititems",  Icon: Pencil },
    { label: "Orders",    desc: "View live & past orders",      to: "/orders",     Icon: ClipboardList },
    { label: "Users & Roles", desc: "Admin/staff access control", to: "/admin/users", Icon: Shield },
    { label: "Reports",   desc: "Sales & inventory insights",   to: "/reports",    Icon: BarChart3 },
    { label: "Settings",  desc: "Store, taxes, printers…",      to: "/settings",   Icon: Settings },
  ];
